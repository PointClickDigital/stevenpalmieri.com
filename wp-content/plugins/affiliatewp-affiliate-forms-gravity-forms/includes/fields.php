...
function affwp_afgf_gform_field_input( $input, $field, $value, $lead_id, $form_id ) {
	...
	switch ( $field["type"] ) {
		...
		case 'username':
			 ...
			 ?>
			  ...
			  <div class="ginput_container">
				 <input name="input_<?php echo esc_attr( $field["id"] ); ?>" id="input_<?php echo esc_attr( $form_id ); ?>_<?php echo esc_attr( $field["id"] ); ?>" type="text" value="<?php echo esc_html( $value ); ?>" class="<?php echo $class; ?> <?php echo $css; ?>" <?php echo $max_length; ?> <?php echo $tabindex; ?> <?php echo $html5_attributes; ?> <?php echo $disabled_text; ?>/>
			   </div>
		...
		case 'payment_email':
			...
			<div class="ginput_container">
				<input name="input_<?php echo esc_attr( $field["id"] ); ?>" id="input_<?php echo esc_attr( $form_id ); ?>_<?php echo esc_attr( $field["id"] ); ?>" type="<?php echo $html_input_type; ?>" value="<?php echo esc_html( $value ); ?>" class="<?php echo $class; ?> <?php echo $css; ?>" <?php echo $max_length; ?> <?php echo $tabindex; ?> <?php echo $html5_attributes; ?> <?php echo $disabled_text; ?>/>
			</div>
		...
		case 'promotion_method':
			...
			<div class="ginput_container">
				<textarea name="input_<?php echo esc_attr( $field["id"] ); ?>" id="input_<?php echo esc_attr( $form_id ); ?>_<?php echo esc_attr( $field["id"] ); ?>" class="textarea <?php echo esc_attr( $field["type"] ); ?> <?php echo $class; ?> <?php echo $css; ?>" <?php echo $tabindex; ?> <?php echo $max_length; ?> rows="10" cols="50" <?php echo $disabled_text; ?>><?php echo esc_html( $value ); ?></textarea>
			</div>
