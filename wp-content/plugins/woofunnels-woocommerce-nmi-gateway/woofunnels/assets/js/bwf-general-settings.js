	...
	let bwfAdminBuilder = function () {
		...
		function get_funnel_settings_fields() {
			...
			for (let keyfields in global_settings_fb_fields) {
				...
				if (Object.prototype.hasOwnProperty.call(bwfAdminGen.globalOptionsFields.fields, model)) {
					$.extend(global_settings_fb_fields[keyfields], bwfAdminGen.globalOptionsFields.fields[model]);
				}
			}
			for (let keyfields in global_settings_ga_fields) {
				let model = global_settings_ga_fields[keyfields].model;
				if (Object.prototype.hasOwnProperty.call(bwfAdminGen.globalOptionsFields.fields, model)) {
					$.extend(global_settings_ga_fields[keyfields], bwfAdminGen.globalOptionsFields.fields[model]);
				}
			}
			...
			for (let keyfields in global_settings_permalinks_fields) {
				...
				if (Object.prototype.hasOwnProperty.call(bwfAdminGen.globalOptionsFields.fields, model)) {
					$.extend(global_settings_permalinks_fields[keyfields], bwfAdminGen.globalOptionsFields.fields[model]);
				}
			}
			...
			if ('1' === bwfAdminGen.is_gad_enabled) {
				let global_settings_gad_fields = [
					...
					//
					// 	label: "",
					// 	styleClasses: "bwf_gsettings_sec_head",
					// 	model: "label_section_head_tan_gad",
					// 	inputName: 'label_section_head_tan_gad',
					// },
					{
						type: "checklist",
						listBox: true,
				...
				for (let keyfields in global_settings_gad_fields) {
					...
					if (Object.prototype.hasOwnProperty.call(bwfAdminGen.globalOptionsFields.fields, model)) {
						$.extend(global_settings_gad_fields[keyfields], bwfAdminGen.globalOptionsFields.fields[model]);
					}
				}
			...
			if ('1' === bwfAdminGen.is_pinterest_enabled) {
				...
				for (let keyfields in global_settings_pint_fields) {
					...
					if (Object.prototype.hasOwnProperty.call(bwfAdminGen.globalOptionsFields.fields, model)) {
						$.extend(global_settings_pint_fields[keyfields], bwfAdminGen.globalOptionsFields.fields[model]);
					}
				}
				settings_config.push({
