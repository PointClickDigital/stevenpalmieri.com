 ...
 * @author   WooThemes
 */
class WooGC_WC_Session_Handler extends WC_Session {
	...
	public function set_customer_session_cookie( $set ) {
		if ( $set ) {
            ...
            if ( ! isset( $_COOKIE[ $this->_cookie ] ) || $_COOKIE[ $this->_cookie ] !== $cookie_value ) 
                {
                    wc_setcookie( $this->_cookie, $cookie_value, $this->_session_expiration, $this->use_secure_cookie() );
                }
	...
	public function set_session_expiration() {
		$this->_session_expiring   = time() + intval( apply_filters( 'wc_session_expiring', 60 * 59 * 24 * 10 ) ); // 10 days - 1 hour
		$this->_session_expiration = time() + intval( apply_filters( 'wc_session_expiration', 60 * 60 * 24 * 10 ) ); // 10 days
	}
	...
	public function destroy_session() {
		// Clear cookie
		wc_setcookie( $this->_cookie, '', time() - YEAR_IN_SECONDS, $this->use_secure_cookie() );
