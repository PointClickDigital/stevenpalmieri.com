                            ...
                            foreach( WC()->cart->get_cart() as $cart_item ) 
                                {
                                    ...
                                    if(pisol_pccdt_product::productHasTimeRange($product_id))
                                        {
                                           $start_time = pisol_pccdt_product::productStartTime($product_id);
                                           $end_time = pisol_pccdt_product::productEndTime($product_id);
