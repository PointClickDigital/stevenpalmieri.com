...
class AdminMenu {
	...
	public function initialize_hooks() {
		add_filter( 'cartflows_react_admin_localize', array( $this, 'supported_payment_gateway' ), 10, 1 );
	 ...
	 *
	 * @param array $localize localixed variables.
	 */
	public function supported_payment_gateway( $localize ) {
