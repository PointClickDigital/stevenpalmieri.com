	...
	public function meta_fields_react( $settings, $step_id, $options ) {
		...
		$settings['settings']['product-options']['fields'] = array(
			...
			'product-option-doc'            => array(
				...
				/* translators: %1$1s: link html start, %2$12: link html end*/
				'content'    => sprintf( __( 'For more information about the product option settings %1$1s Click here. %2$2s', 'cartflows' ), '<a href="https://cartflows.com/docs/set-default-product-in-product-options/" target="_blank">', '</a>' ),
			),
		...
		$settings['settings']['checkout-offer']['fields'] = array(
			...
			'checkout-offer-doc'              => array(
				'type'       => 'doc',
				/* translators: %1$1s: link html start, %2$12: link html end*/
				'content'    => sprintf( __( 'For more information about the pre-checkout offer please %1$1sClick here.%2$2s', 'cartflows' ), '<a href="https://cartflows.com/docs/setup-pre-checkout-upsell/" target="_blank">', '</a>' ),
				'conditions' => array(
					'fields' => array(
						array(
							'name'     => 'wcf-pre-checkout-offer',
	...
	public function design_fields_react( $settings, $options ) {
		...
		$settings['settings']['order-bump-design']['fields'] = array(
			...
			'heading-styles'              => array(
				'type'  => 'heading',
				'label' => esc_html__( 'Styles', 'cartflows' ),
			),*/
