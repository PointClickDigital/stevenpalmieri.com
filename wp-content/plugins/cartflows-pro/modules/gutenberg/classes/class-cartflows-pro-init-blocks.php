...
class Cartflows_Pro_Init_Blocks {
	...
	public function editor_assets() {
		...
		if ( CARTFLOWS_STEP_POST_TYPE === $post_type ) {
			...
			$enable_checkout_offer  = wcf()->options->get_checkout_meta_value( $post_id, 'wcf-pre-checkout-offer' );
			...
			wp_enqueue_style( 'CFP_block-cartflows-frotend-style', CARTFLOWS_PRO_URL . 'assets/css/frontend.css', array(), CARTFLOWS_PRO_VER );
			wp_enqueue_style( 'cartflows-pro-optin-style', wcf_pro()->utils->get_css_url( 'optin-styles' ), '', CARTFLOWS_PRO_VER );
			wp_enqueue_style( 'cartflows-pro-checkout-style', wcf_pro()->utils->get_css_url( 'checkout-styles' ), '', CARTFLOWS_PRO_VER );
