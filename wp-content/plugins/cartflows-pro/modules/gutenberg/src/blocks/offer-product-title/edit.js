...
class OfferProductTitle extends Component {
	...
	componentDidMount() {
		...
		$style.setAttribute( "id", "wpcfp-offer-product-title-style-" + this.props.clientId.substr( 0, 8 ) )
		document.head.appendChild( $style )
    }

	componentDidUpdate(prevProps, prevState) {
		var element = document.getElementById( "wpcfp-offer-product-title-style-" + this.props.clientId.substr( 0, 8 ) )
