...
function styling( props ) {
    ...
    selectors = {
        ...
        " .wpcfp__offer-product-price .wcf-offer-price": {
        ...
        " .wpcfp__offer-product-price:hover": {
            "color"			  : textHoverColor,
        },
        
    }

    tablet_selectors[" .wpcfp__offer-product-price .wcf-offer-price"] = {
    ...
    mobile_selectors[" .wpcfp__offer-product-price .wcf-offer-price"] = {
