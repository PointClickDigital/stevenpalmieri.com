...
class Cartflows_Pro_Base_Offer_Shortcodes {
	...
	public function product_price() {
		...
		if ( _is_wcf_base_offer_type() ) {
			...
			$display_price          = wcf_pro_filter_price( $offer_product['display_price'] );
			$display_original_price = wcf_pro_filter_price( $offer_product['display_original_price'] );
			$shipping_fee           = wcf_pro_filter_price( $offer_product['shipping_fee'] );
