...
if ( ! class_exists( 'Cartflows_Pro_Loader' ) ) {
	...
	final class Cartflows_Pro_Loader {
		...
		public function define_constants() {
			...
			define( 'CARTFLOWS_PRO_REQ_CF_VER', '1.6.12' );
		...
		public function load_core_components() {
			...
			if ( is_admin() && $this->is_legacy_admin() ) {
				include_once CARTFLOWS_PRO_DIR . 'admin-legacy/class-cartflows-pro-legacy-admin-loader.php';
			}
		...
		public function fail_load_out_of_date() {
			...
			$message  = '<p>' . sprintf( __( 'You are using an older version of CartFlows. This version of CartFlows Pro needs a CartFlows version %s or greater.', 'cartflows-pro' ), CARTFLOWS_PRO_REQ_CF_VER ) . '</p>';
		 ...
		 * Is legacy admin
		 */
		public function is_legacy_admin() {

			if ( defined( 'CARTFLOWS_LEGACY_ADMIN' ) ) {
