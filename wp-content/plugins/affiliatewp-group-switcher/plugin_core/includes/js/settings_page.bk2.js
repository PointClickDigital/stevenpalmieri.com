jQuery(document).ready(function () {
    ...
    function addRow() {
        ...
        if (row.find("select[name*=AFFWP_GS_gs_rules]").length) {
            row.find("select[name*=AFFWP_GS_gs_rules]").each(showDivOnOption).change(showDivOnOption);
        }
    ...
    jQuery("select[name*=AFFWP_GS_gs_rules]").each(showDivOnOption).change(showDivOnOption);
