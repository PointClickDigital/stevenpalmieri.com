...
// Define Constants
define('DETHEMEKIT_ADDONS_VERSION', '1.5.5');
...
define('DETHEMEKIT_ADDONS_STABLE_VERSION', '1.5.5');
...
final class Detheme_Kit {
	...
	public function load_domain() {
		...
		load_plugin_textdomain( 'dethemekit-addons-for-elementor' );
	...
	public function init_templates() {
		...
		// require_once ( DETHEMEKIT_ADDONS_PATH . 'includes/admin/include/template-library.php');
	}
