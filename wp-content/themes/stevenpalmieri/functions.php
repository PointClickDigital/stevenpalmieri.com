 ...
 */
add_filter ( 'woocommerce_account_menu_items', 'pcd_upgrade_link', 40 );
function pcd_upgrade_link( $menu_links ){
 ...
 */
add_action( 'init', 'pcd_add_endpoint' );
function pcd_add_endpoint() {
 ...
 */
add_action( 'woocommerce_account_log-history_endpoint', 'pcd_my_account_endpoint_content' );
function pcd_my_account_endpoint_content() {
